 ...
 * @return array
 */
function lire_migration_depuis_status($finished = false) {
return lire_migration_status('depuis', $finished);
}
/**
 * Lire le status de migration vers
 * @return array
 */
function lire_migration_vers_status() {
return lire_migration_status('vers');
}
 ...
 * @return bool
 */
function finir_migration_status_depuis() {
return finir_migration_status('depuis');
}
